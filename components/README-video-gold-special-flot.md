...
## Modo video vertical con fondos decorativos

Cuando se pasan los atributos `fondo-izquierda` y/o `fondo-derecha`, el componente activa un layout especial:

- El video se muestra en formato **portrait (9:16)** centrado en la card
- Los PNG decorativos llenan los paneles laterales izquierdo y derecho
- La card se expande automáticamente hasta **95vw** (tanto en desktop como en mobile) para aprovechar el espacio disponible
...
```html
<video-gold-special
  titulo="Video Especial Vertical"
  video-desktop="./video-vertical.mp4"
  video-mobile="./video-vertical.mp4"
  fondo-izquierda="./img/fondo-izq.png"
  fondo-derecha="./img/fondo-der.png"
  badge="Especial"
  etiqueta="Edición Vertical">
</video-gold-special>
```

> **Tip:** Funciona mejor con PNG sin fondo blanco o con imágenes que tengan contenido interesante en los bordes, ya que el centro se fusiona con el video.
