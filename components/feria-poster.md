...
| `modal-image` | `string` (URL) | No | Imagen que se muestra en el modal de zoom. Fallback: `poster-mobile` → `poster-desktop`. |
...
Al hacer clic (o tocar) sobre el afiche se abre un modal fullscreen con la imagen `modal-image`.
